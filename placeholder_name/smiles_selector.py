...
class SMILESSelector:
    ...
    def _strategy_ordered_priority(self, smiles_dict: Dict[str, List[str]], priority_order: List[str], **kwargs) -> str:
        """
        ...
        if not priority_order:
            raise ValueError("Priority order must be provided for 'ordered' strategy.")
        ...
        for resolver in priority_order:
