...
More information about advanced usage can be found in [Resolvers](resolvers.md), [SmilesSelection](smiles_selection.md), and [Name Correction/Editing](name_manipulation.md)