...
def get_delimiter_split_dict(
    compound_name: str, 
    split_compound_name_dict: Dict[str, List[str]]
...
def get_smiles_resolvers_combinations(compound_smiles_list: List[Tuple[str, List[str]]]) -> Dict[str, List[str]]:
    """
...
def resolve_delimiter_split_dict(
    ...
    smiles_parts_dict = get_smiles_parts_from_name_parts(compound, resolvers_out_dict, delimiter_split_dict)
